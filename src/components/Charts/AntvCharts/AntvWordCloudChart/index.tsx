...
const AntvWordCloudChart = () => {
    const containerRef = useRef<HTMLDivElement | null>(null);

    function getDataList(data: DataType[]) {
    ...
    useEffect(() => {
        ...
        wordCloudPlot.render().then()

        return () => {
            wordCloudPlot.destroy(); // 销毁 wordCloudPlot 实例
        };
    }, []);
...
export default AntvWordCloudChart;